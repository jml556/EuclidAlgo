/*
I included props from book 1, 1-3 and book 2, 1-2 to see if the algorithm would work on a smaller set of data. 
*/

const euclidText = `BOOK I.
Proposition 1.
...
console.log(orderEuclid(euclidText))
